...
jQuery(function($) {
  ...
  function updateTable1() {
    ...
    function selectRows() {
	  ...
	  editCount += blog.value.editorCount;
        }
      }
      ...
      $("#emailUsersPopup label[for='editRolePopup']").text("Editors (" + editCount + ')');
      ...
      $("#emailUsersPopup input#editRolePopup").prop('disabled', (editCount !== 0) ? false : true);
    }
  ...
  function calTable6() {
	...
	var editorCount = blog.editorCount;
	...
	editorCountAll += editorCount;
        tr += '<tr><td></td><td><span>' + blogName + '</span><a class="jumpLink"><img src="./images/menu.svg" alt="Blogs" /></a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(authorCount) + '</a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(subCount) + '</a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(conCount) + '</a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(siteCount) + '</a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(adminCount) + '</a></td><td><a class="showUserDetailOverlay" href="javascript:">' + formatNumber(editorCount) + '</a></td></tr>';
      }
      $('#table6 table').append(tr + '</tbody>');
      var total = '<tbody><tr><td></td><td>Total = ' + formatNumber(totalCount) + '</td><td>' + formatNumber(authorCountAll) + '</td><td>' + formatNumber(subCountAll) + '</td><td>' + formatNumber(conCountAll) + '</td><td>' + formatNumber(siteCountAll) + '</td><td>' + formatNumber(adminCountAll) + '</td><td>' + formatNumber(editorCountAll) + '</td></tr></tbody>';
